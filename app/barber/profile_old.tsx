...
const styles = StyleSheet.create({
  ...
  primaryBtn: { backgroundColor: panelTheme.dark, borderRadius: 14, paddingVertical: 14, alignItems: "center", marginTop: 8, boxShadow: "0px 4px 8px rgba(15, 23, 42, 0.08)", elevation: 2 },
